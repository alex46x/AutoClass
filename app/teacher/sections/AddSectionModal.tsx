...
import { addDepartmentSection } from '@/app/actions/head';
import { motion, AnimatePresence } from 'framer-motion';

export default function AddSectionModal({ semesterId }: { semesterId: number }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await addDepartmentSection(semesterId, name, maxStudents);
      setIsOpen(false);
      setName('');
      setMaxStudents(40);
    } catch (err: any) {
