...
import { editDepartmentSection } from '@/app/actions/head';
import { motion, AnimatePresence } from 'framer-motion';

export default function EditSectionModal({ sectionId, currentName, currentMaxStudents }: { sectionId: number, currentName: string, currentMaxStudents: number }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await editDepartmentSection(sectionId, name, maxStudents);
      setIsOpen(false);
    } catch (err: any) {
